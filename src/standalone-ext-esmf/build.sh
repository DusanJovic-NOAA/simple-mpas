...
cmake .. -DMPAS_CORES='atmosphere' -DCMAKE_INSTALL_PREFIX=../install -DMPAS_DOUBLE_PRECISION=OFF -DMPAS_USE_PIO=ON -DBUILD_SHARED_LIBS=OFF -DMPAS_OPENMP=OFF -DCMAKE_BUILD_TYPE=Release
